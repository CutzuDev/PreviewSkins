      ...
      <div className="grid h-full w-full items-center justify-center gap-8 2xl:grid-cols-3">
        {list.map((item) => (
          <div className="flex h-full w-full flex-col items-center justify-between overflow-hidden rounded-xl shadow-customBox shadow-neutral-900">
            ...
            <h1 className="relative flex h-16 w-full items-center justify-center bg-gradient-to-tl from-yellow-900 to-yellow-500 text-center font-righteous text-xl font-regular text-white 2xl:h-20 2xl:text-3xl">
              {item.name}
              <a
                href={item.download}
